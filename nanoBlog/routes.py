...
from nanoBlog.forms import RegistrationForm,LoginForm, UpdateAccountForm,PostForm
...
def post(post_id):
    post = Post.query.get_or_404(post_id)       #get the post if it exists or return 404 error
